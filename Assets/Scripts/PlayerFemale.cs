...
public class PlayerFemale : MonoBehaviour//第一和第三人称控制差的不少 就不共用父类了..
{
    ...
    [SerializeField] Rigidbody rb;//mesh的rb，因为blender单位长度和Unity不一样，所以要额外给rb加一个正确的重力
    [SerializeField] Animator animator;//mesh的animation controller
